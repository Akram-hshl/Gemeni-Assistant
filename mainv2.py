...
# Initialize text-to-speech engine using espeak for Linux compatibility
...
def generate_response(query):
    ...
    try:
        ...
        conversation_area.insert(tk.END, f"Error generating response: {e}\n")
        speak("Sorry, I encountered an error generating a response.")
